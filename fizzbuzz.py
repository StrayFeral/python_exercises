...
class FizzBuzzer:
    ...
    def solution1(self, rng: int = fizzbuzz_range) -> None:
    ...
    def solution2(self, rng: int = fizzbuzz_range) -> None:
    ...
    def solution3(self, rng: int = fizzbuzz_range) -> None:
        ...
        print(
            *map(
                lambda i: "[{0}] {1}{2}".format(
                    i, "Fizz" * (i % 3 == 0), "Buzz" * (i % 5 == 0)
                ),
                range(1, rng + 1),
            ),
            sep="\n"
